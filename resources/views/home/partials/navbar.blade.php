        ...
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center brand-hover" href="{{ route('beranda') }}" style="transition: all 0.3s ease;">
                <div class="logo-container position-relative me-3">
                    <img src="{{ asset('img/logo.jpeg') }}" alt="Logo Edukasi Pertanian" 
                         class="logo-img" 
                ...
                <div class="brand-text">
                    <h1 class="h4 mb-0 fw-bold" style="background: linear-gradient(135deg, #28a745, #20c997); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">EDUKASI PERTANIAN</h1>
