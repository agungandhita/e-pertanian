                    ...
                    <form action="{{ route('admin.artikel.update', $artikel) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    @if($artikel->gambar)
                                        <div id="current-image" class="border rounded p-3 text-center" style="min-height: 200px;">
                                            <img src="{{ $artikel->gambar_url }}" alt="Current Image" class="img-fluid" style="max-height: 180px;">
                                            <p class="text-muted mt-2 mb-0"><small>Gambar saat ini</small></p>
                                        </div>
                                    @endif
                                    ...
                                    <div id="image-preview" class="border rounded p-3 text-center" style="min-height: 200px; display: none;">
                                        ...
                                        <p class="text-muted mt-2 mb-0"><small>Preview gambar baru</small></p>
                                    </div>
