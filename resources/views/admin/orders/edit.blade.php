        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Edit Pesanan #{{ $order->order_number }}</h3>
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="user_id" class="form-label">Pembeli <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" 
                                                   value="{{ old('phone', $order->phone) }}" placeholder="Masukkan nomor telepon">
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="shipping_address" class="form-label">Alamat Pengiriman</label>
                                            <textarea class="form-control" id="shipping_address" name="shipping_address" 
                                                      rows="3" placeholder="Masukkan alamat lengkap">{{ old('shipping_address', $order->shipping_address) }}</textarea>
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="notes" class="form-label">Catatan</label>
                                            <textarea class="form-control" id="notes" name="notes" 
                                                      rows="2" placeholder="Catatan tambahan (opsional)">{{ old('notes', $order->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="payment_method" name="payment_method" required>
                                                ...
                                                <option value="dana" {{ $order->payment_method == 'dana' ? 'selected' : '' }}>DANA</option>
                                            ...
                                            <div class="product-item border rounded p-3 mb-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-control-plaintext fw-bold subtotal">
                                        ...
                                        <div class="border-top pt-3 mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <strong class="text-success fs-5" id="totalAmount">
...
@push('scripts')
<script>
let productIndex = {{ $order->orderItems->count() }};
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.product-item').forEach(item => {
        ...
        // Update stock info for existing items
        updateSubtotal({ target: productSelect });
    });
});
